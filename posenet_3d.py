...
def main():
    ...
    while True:
        ...
        dp.data_prossessing(keypoints_list_list,scores_list_list,cam_list)
...
def draw_debug(
    ...
    cv.putText(debug_image,
               ...
               (10, 60), cv.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 4,
               cv.LINE_AA)
    cv.putText(debug_image,
               "FPS: " + '{:.1f}'.format(fps) + "fps",
               (10, 60), cv.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0), 2,
               cv.LINE_AA)
